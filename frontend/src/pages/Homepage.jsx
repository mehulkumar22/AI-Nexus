...
import { ArrowRight, Shield, Image, Sparkles, Zap, Users, Globe, Check, Star, Award, TrendingUp } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              ...
              <Link
                to="/login"
                className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-200 shadow-lg"
              >
                Join Now
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <button className={`w-full px-6 py-4 font-bold rounded-xl transition-all duration-200 ${
                  plan.popular
