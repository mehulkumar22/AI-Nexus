...
import { Image, Wand2, Download, RefreshCw, Sparkles, Settings, Palette, AlertTriangle, Copy } from 'lucide-react';
                ...
                <div className="bg-white/5 backdrop-blur-sm md:backdrop-blur-xl rounded-xl md:rounded-2xl p-4 md:p-6 border border-white/10 shadow-lg md:shadow-2xl">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-3 md:mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-xs md:text-sm">"{result.prompt}"</p>
                    </div>
                  ...
                  <div className="flex flex-wrap items-center gap-1 md:gap-2">
                    <div className="px-2 py-1 md:px-3 md:py-1 bg-purple-500/20 text-purple-300 rounded-full text-xs font-medium">
                      {result.style.charAt(0).toUpperCase() + result.style.slice(1)} Style
                    </div>
                  ...
                  {result.images.map((image, index) => (
                    ...
                    >
                      ...
                      <div className="relative rounded-lg overflow-hidden mb-3 md:mb-4">
                        <div className="bg-gray-900 flex justify-center" style={{ height: '40vh' }}>
                          <img
                            src={image.url}
                            alt={`Generated image from: ${result.prompt}`}
                      ...
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          className="p-2 bg-gray-700/50 text-gray-300 rounded-lg hover:bg-gray-700/70 transition-all duration-200"
                          title="Copy link"
                        >
